...
Shader "Nauman/Matcap_TextureArrays" {
	Properties{
...
#pragma target 3.0
	...
	float3 finalColor = emissive + ((((_matcap_var.rgb*_color_var.a) + (pow(1.0 - max(0,dot(i.normalDir, viewDirection)),4.0)*_rimlightcolor.rgb))*(i.normalDir.g*-0.2 + 0.7))*0.5);
